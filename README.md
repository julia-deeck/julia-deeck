...
Me chamo Júlia Rosa, tenho 22 anos. Atualmente curso Ciência da Computação na Universidade Tiradentes (UNIT). Participei do AWS re/Start, que faz parte do Instituto Aliança com foco em cloud computing, e também participei do projeto Com Domínio Digital 4.0, que também faz parte do Instituto Aliança, com foco em programação, bancos de dados e metodologias ágeis. Tenho conhecimento em Java, Python, SQL, Git, e lógica de programação.
